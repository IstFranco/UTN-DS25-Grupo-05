...
// Obtener empresa (Ahora solo devuelve el nombre, como espera el frontend)
export const obtenerEmpresa = async (req: Request, res: Response) => {
    try {
        const { id } = req.params;
        
        // 1. Búsqueda optimizada: solo seleccionamos el 'nombre'
...
        // 2. Devolvemos el objeto { nombre: "..." } que el frontend espera
        return res.json({ nombre: empresa.nombre });
